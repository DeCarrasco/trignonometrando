...
App.graficos = (function ()
{
  ...
  */
  ...
  var inicio = function ()
  {
    ...
    */
    mensagem = "Gráficos das Funções Básicas";
    ...
    mensagem = " - Para interagir, utilize as teclas direcionais";
    App.strategiesTela.construtorTexto.executa([
      "2",
      mensagem,
      "#191970",
    ...
    mensagem = "(para cima e para baixo) do seu teclado.";
    App.strategiesTela.construtorTexto.executa([
      "2",
      mensagem,
      "#191970",
