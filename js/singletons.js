  ...
  App.singletons = (function ()
  {
    ...
    var singletonCanvas = (function ()
    {
        ...
        function inicia()
        {
          ...
          var CV_WIDTH = ($(CT).width() - 10);
          var CV_HEIGHT = $(CT).height() - 10;
    ...
    var singletonImagens = (function ()
    {
        ...
        function inicia()
        {
          ...
          imagem["lousa"] = new Image();
          imagem["lousa"].src = "./imagens/lousa.png";

          imagem["titulo"] = new Image();
          imagem["titulo"].src = "./imagens/trigo.png";

          imagem["compasso"] = new Image();
          imagem["compasso"].src = "./imagens/compasso.png";

          imagem["grafico"] = new Image();
          imagem["grafico"].src = "./imagens/grafico.png";

          imagem["cadernoDireita"] = new Image();
          imagem["cadernoDireita"].src = "./imagens/caderno2.png";

          imagem["cadernoEsquerda"] = new Image();
          imagem["cadernoEsquerda"].src = "./imagens/caderno.png";

          imagem["teclas"] = new Image();
          imagem["teclas"].src = "./imagens/teclas.png";
          ...
          imagem["lapis"] = new Image();
          imagem["lapis"].src = "./imagens/lapis.png";

          imagem["interrogacao"] = new Image();
          imagem["interrogacao"].src = "./imagens/interrogacao.png";

          imagem["exclamacao"] = new Image();
          imagem["exclamacao"].src = "./imagens/exclamacao.png";

          imagem["btOk"] = new Image();
          imagem["btOk"].src = "./imagens/ok.png";

          imagem["desafio"] = new Image();
          imagem["desafio"].src = "./imagens/desafio.png";

          imagem["desafioFrente"] = new Image();
          imagem["desafioFrente"].src = "./imagens/desafioFrente.png";
